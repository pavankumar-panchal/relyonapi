...
switch($submittype)
{
	...
	{	 
		  ...
		  $grid .= '<tr class="gridheader">
			...
			<td nowrap="nowrap"  class="tdborderlead">Product Version</td>
	...
	case "latestactivity":
	{
		...
		if(($p_flashnewsupdate == 1 && ($p_versionupdate == '1' || $p_hotfixupdate == '1')))
		{
			$query .= "union";	
		}
		...
		{
			$query .= "(select reldate as adddeddate ,product as product ,0 as disable ,hotfixno as hotfixno ,
		...
		if(($p_flashnewsupdate == 1 && ($p_versionupdate == '1' || $p_hotfixupdate == '1') && 
			($p_saralmail_delete == '1' || $p_saralmail == '1')) || ($p_flashnewsupdate == 1 && 
			($p_saralmail_delete == '1' || $p_saralmail == '1')) || (($p_versionupdate == '1' || $p_hotfixupdate == '1') && 
			($p_saralmail_delete == '1' || $p_saralmail == '1')))
		{
			$query .= "union";	
		}
		...
		{
			$query .= "(select createddate as adddeddate ,0 as product ,0 as disable ,0 as hotfixno ,
		...
		if(($p_flashnewsupdate == 1 && ($p_versionupdate == '1' || $p_hotfixupdate == '1') && 
			($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_saralmail_disable == '1') ||($p_flashnewsupdate == 1 && 
			($p_versionupdate == '1' || $p_hotfixupdate == '1') && $p_saralmail_disable == '1') || ($p_flashnewsupdate == 1 && 
			($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_saralmail_disable == '1')|| (($p_versionupdate == '1' || 
			$p_hotfixupdate == '1') && ($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_saralmail_disable == '1')|| 
			(($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_saralmail_disable == '1') ||
			(($p_versionupdate == '1' || $p_hotfixupdate == '1') &&  $p_saralmail_disable == '1') ||($p_flashnewsupdate == 1 &&  
			$p_saralmail_disable == '1'))
		{
			$query .= "union";	
		}
		...
		{
			$query .= "(select disabledate as adddeddate ,0 as product ,disable as disable ,0 as hotfixno ,
			0 as verfrom , employee as employee , deleted as deleted , 0 as updatetype ,
			0 as department , 0 as showinweb, disabledate as disabledate  from email_acc_record 
		...
		if(($p_flashnewsupdate == 1 && ($p_versionupdate == '1' || $p_hotfixupdate == '1') && 
			($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_saralmail_disable == '1' && $p_career == '1') 
			|| ($p_flashnewsupdate == 1 && ($p_versionupdate == '1' || $p_hotfixupdate == '1') && $p_saralmail_disable == '1' 
			&& $p_career == '1') || ($p_flashnewsupdate == 1 && ($p_saralmail_delete == '1' || $p_saralmail == '1') 
			&& $p_saralmail_disable == '1' && ($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_career == '1') || 
			($p_saralmail_delete == '1' && ($p_versionupdate == '1' || $p_hotfixupdate == '1') && $p_saralmail_disable == '1'&& 
			$p_career == '1') ||(($p_saralmail_delete == '1' || $p_saralmail == '1') && $p_saralmail_disable == '1' && 
			$p_career == '1')|| (($p_saralmail_delete == '1' || $p_saralmail == '1') && 
			($p_versionupdate == '1' || $p_hotfixupdate == '1') && $p_career == '1') ||
			 (($p_saralmail_delete == '1' || $p_saralmail == '1') &&  $p_flashnewsupdate == 1 && $p_career == '1')||
			 ($p_saralmail_disable == '1' && $p_career == '1') ||($p_flashnewsupdate == 1 && $p_career == '1') ||
			 (($p_versionupdate == '1' || $p_hotfixupdate == '1') && $p_career == '1') ||(($p_saralmail_delete == '1' ||
			  $p_saralmail == '1') && $p_career == '1'))
		{
			$query .= "union";	
		}
