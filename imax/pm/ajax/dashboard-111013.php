...
/*		if($command == 'active')
		{
			$query = $query1." where email_acc_record.deleted ='NO' and email_acc_record.disable = '0' order by 
			email_acc_record.createddate desc LIMIT 5";
		}
		else if($command == 'disabled')
		{
			$query = $query1." where email_acc_record.deleted ='NO' and email_acc_record.disable = '1' order by 
			email_acc_record.emailid desc LIMIT 5";
		}
		else if($command =='deleted')
		{
			$query = $query1." where email_acc_record.deleted ='YES' order by email_acc_record.emailid desc LIMIT 5";
		}
*/			 
