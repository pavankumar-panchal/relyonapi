...
//$responseurl = "http://www.relyonsoft.com/home_old/makepayment/complete_citrus.php"; //Should not exceed 80 Chars


$responseurl = "http://relyonsoft.com/imax/sppnewupdatepurchase/makepayment/compcit.php";
//$responseurl = "https://saraleip.com/saralimax/updationpay/makepayment/complete_citrus.php";
...
$query_txnid = "update inv_spp_amc_pinv set txnid = '".$txnid."' where slno = '".$lslnop."' ";
...
// Net banking code begins. Do not alter anything Further - Nagamani .....17-09-2012..............................
	...
	$orderAmount=$userdetails['amount'];
	...
	$_POST['returnUrl'] = "http://relyonsoft.com/imax/sppnewupdatepurchase/makepayment/compcit.php";

	//$_POST['returnUrl'] = "https://saraleip.com/saralimax/updationpay/makepayment/complete_citrus.php";

	$_POST['orderAmount'] = $userdetails['amount'];
	...
	$returnUrl='http://relyonsoft.com/imax/sppnewupdatepurchase/makepayment/compcit.php';

	//$returnUrl='https://saraleip.com/saralimax/updationpay/makepayment/complete_citrus.php';
	...
	?>
     ...
     <form action="<?php echo $action; ?>" method="POST"
		...
		<p>
			...
			Time: <input type="text" name="reqtime" value="<?php echo $time;?>" /> 
