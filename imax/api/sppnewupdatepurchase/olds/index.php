<?php
	...
	$actualprice =""; $updationprice=""; $checkproductcode="";
        ...
        //$query1 = "SELECT  * from `inv_spp_amc_pinv` where slno = '".$productcode."'";
...
if(!$fetch1)
{
  ...
  exit();
	 ...
	 $emailid = $fetch_customer['emailid1'];
        ...
        $query_dealer = "SELECT businessname from `inv_mas_dealer` WHERE slno = ".$currentdealer.";";
...
$grid="<table border='1px solid black' style='border-collapse: collapse;' width='100%'><tr><td class='tabsclass'>Sl No.</td><td  class='tabsclass'>Product Name</td><td class='tabsclass'>Amount</td></tr>";
       $product='';
...
$grid .= '<tr>
<td  width="50%" style="text-align:right"><div align="left"></div></td>
<td  width="30%" style="text-align:right"><strong>Total</strong></td>
<td  width="18%" style="text-align:right"><img src="../images/relyon-rupee-small.jpg" width="8" height="8" border="0" align="absmiddle"  />&nbsp;&nbsp;'.formatnumber($fetch1['netamount'] ).$appendzero.'</td> 
...
<form method="post" action="" method="post" name="submitexistform" id="submitexistform">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <table width="270" border="0" cellpadding="4" cellspacing="0" class="dashboardprofilebox">
                              ...
                              <tr>
                               ...
                               <tr>
								<td height="20px">Dealer : <?php echo(gridtrim40($currentdealer_name));?></td>
                              </tr>
                              <tr>
    ...
    <tr>
      <td colspan="2"><center><span class="sub_headingfont mybutton" onclick="paynow('<?php echo $show_slno; ?>')"> Pay Now </span></center></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
