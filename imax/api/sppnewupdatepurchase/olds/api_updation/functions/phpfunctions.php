...
//$newconnection_old = mysql_connect($dbhost_old, $dbuser_old, $dbpwd_old) or die("Cannot connect to Mysql server host_old");
...
;
	...
	if($filebasename <> '')
	{
		...
		{
			$bccemailids = array('Bigmail' => 'bigmail@relyonsoft.com', 'Accounts'=> 'bills@relyonsoft.com', 'Webmaster' => 'webmaster@relyonsoft.com', 'Relyonimax' => 'relyonimax@gmail.com', 'Usha' => 'dealers@relyonsoft.com', 'Madhuri H N' => 'madhuri.hn@relyonsoft.com');
		}
		$bccarray = $bccemailids;
		$msg = replacemailvariable($msg,$array);
		$textmsg = replacemailvariable($textmsg,$array);
