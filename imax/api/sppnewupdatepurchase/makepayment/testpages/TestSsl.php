...
include("Sfa/AirLineTransaction.php");
	...
	$oMerchant->setMerchantDetails("00001203","00001203","00001203","193.545.34.33",rand()."","Ord123","http://10.10.10.147:8756/SFAResponse.php","POST","INR","INV123","req.Preauthorization","100","","Ext1","true","Ext3","Ext4","Ext5");
