...
<html>
	...
	<body onLoad="document.frm1.submit()">
        ...
        $responseSuccessURL = "http://relyonsoft.com/imax/api/sppnewupdatepurchase/makepayment/complete.php"; //Need to change as per location of response page
        $responseFailURL = "http://relyonsoft.com/imax/api/sppnewupdatepurchase/makepayment/complete.php";       //Need to change as per location of response page
