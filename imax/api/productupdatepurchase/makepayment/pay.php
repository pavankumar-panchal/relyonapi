...
<html>
	...
	<body onload="document.frm1.submit()">
        ...
        $responseSuccessURL = "http://relyonsoft.com/imax/api/productupdatepurchase/makepayment/complete.php"; //Need to change as per location of response page
        $responseFailURL = "http://relyonsoft.com/imax/api/productupdatepurchase/makepayment/complete.php";       //Need to change as per location of response page
