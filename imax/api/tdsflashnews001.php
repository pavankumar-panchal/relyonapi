...
$grid = '<div id="nt-example1-container"><img src="custom/up.png" id="nt-example1-prev"><ul id="nt-example1">';
...
while($fetch = mysql_fetch_array($result1))
{
	...
	$grid .= '<li><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="20" align="center" bgcolor="#009933" style="border-top:1px solid #009933; color:#FFFFFF">'.($i_n+1).'</td><td style="border-top:1px solid #009933">&nbsp;</td></tr></table>';
	//Give the Flash text with link and title
	$grid .= '<a '.$linktext.' target="_blank"  title="'.$title.'"><font color="'.$color.'">'.$text.'</font></a></li>';
	$i_n++;
}

$grid .= ' </ul><img src="custom/down.png" id="nt-example1-next"></div>';
...
<body style="background-color:#FFF;margin: 0px !important;">
...
<!-- Custom Js -->
    ...
    <script src="custom/jquery.newsTicker.js"></script>
    <script>    		
