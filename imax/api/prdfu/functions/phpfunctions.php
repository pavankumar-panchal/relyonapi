...
$newconnection_old = mysql_connect($dbhost_old, $dbuser_old, $dbpwd_old) or die("Cannot connect to Mysql server host"); // - Cannot connect to Mysql server host - Check reyonsoft.com Database

// if(!newconnection_old)
// {
// 	echo "not connected";
// }
// else
...
function runmysqlquery($query)
{
	...
	//Connect to Database
	mysql_select_db($dbname,$newconnection) or die("Cannot connect to database 1= ".$query);
	set_time_limit(3600);
	//Run the query
...
function runmysqlquery_old($query)
{
	...
	//Connect to Database
	mysql_select_db($dbname,$newconnection_old) or die("Cannot connect to database 3= ".$query);
	set_time_limit(3600);
	//Run the query
