...
<form  method="post" action="prdfu_show15.php">
  <table border="0"  class="maintable" cellpadding="0" cellspacing="10" align="center" >
    ...
    <tr>
      ...
      <td width="3%">:</td>
      <td ><input type="text" name="selecttype" id="selecttype" size="34" tabindex="10"
      class="inputdata" autocomplete="off">
      <!--<select name="selecttype" class="inputdata" style="height:20px; width:223px" tabindex="10">
