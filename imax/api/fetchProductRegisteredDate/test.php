...
if (!empty($_REQUEST["Qa1iio9"]) && !empty($_REQUEST["AsWrIo"]) && !empty($_REQUEST["UasffU"]))
{
    ...
    $scratchNumber = $_REQUEST['UasffU']; //exit;
    //$custId=$_REQUEST['Qa1iio9'];
    //$prdId=$_REQUEST['AsWrIo'];
    ...
    if ($rows_count > 0)
    {
        ...
        if ($prdId_count > 0)
        {
            ...
            if ($scratchId_count > 0)
            {
                ...
                where inv_customerproduct.customerreference='" . $custId . "' and inv_customerproduct.computerid ='" . $prdId . "' and inv_customerproduct.cardid = '" . $cardId . "'";
                ...
                if ($cust_prd_pin_count > 0)
                {
                    ...
                    //$response['Attached Date'] = $attachdate;
                }
                else
                {
