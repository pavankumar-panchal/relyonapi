...
function logdetailsregister2($CUSTID,$REGTYPE,$PID,$UNAME,$DWP,$PIN,$HDDID,$ETHID,$UDCID,$CMPNAME,$CMPID,$LGNTYPE,$REMARKS)
{
	...
	$q2 = "INSERT INTO inv_logs_register2(CUSTID,REGTYPE,PPID,UNAME,PASS,PIN,HDDID,ETHID,UDCID,CMPNAME,CMPID,LGNTYPE,BROWSER,SYSTEMIP,DATES,REMARKS) 			VALUES('".$CUSTID."','".$REGTYPE."','".$PID."','".$UNAME."','".$DWP."','".$PIN."','".$HDDID."',
			'".$ETHID."','".$UDCID."','".$CMPNAME."','".$CMPID."','".$LGNTYPE."','".$BROWSER."','".$SYSTEMIP."','".$DATETIME."','". $REMARKS."');";
	$r2 = runmysqlquery($q2);
}
